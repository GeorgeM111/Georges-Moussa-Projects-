...
<body>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid  border-top border-dark border-top-3  px-4">
                ...
                <div class="row my-5">
                    ...
                    <?php printItemsForStock($connection);
                    $connection->close();
                    ?>
                </div>
    ...
    <script>
        ...
        function toggleStock(ID, stock) {
            let question = "add this item to";
            let stockToBeModified = "in";
            if (stock === 'in') {
                question = "remove this item from";
                stockToBeModified = "out";
            }
            const userConfirmed = window.confirm("Are you sure you want to " + question + " the stock ?");
            ...
            if (userConfirmed) {
                ...
                $.ajax({
                    ...
                    data: {
                        itemID: itemID,
                        stockToBeModified: stockToBeModified,
                    },
                    success: function(response) {
                        ...
                        try {
                            ...
                            alert('Failed To Update Stock! Error: Invalid JSON response');
                        }
                    },
