...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST['id'])) {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Account Access Restored';
            $mail->Body    = "Dear {$fullName},<br><br> We have reviewed your account and reinstated access. You can now log into our website and use it normally.<br> If you have any further questions or require assistance, please contact us.<br><br>Best Regards,<br>Daddy's Restaurant.";
