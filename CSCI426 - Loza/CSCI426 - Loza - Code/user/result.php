...
<body>
  <div class="container-fluid px-0 mx-0">
    ...
    <?php if(!isset($_SESSION['cart'])){ header("Location: home.php");} ?>
    <div class="row m-4">
    ...
    <table class="table italiana-regular text-bold fs-5">
      ...
      <tbody>
        ...
        foreach ($_SESSION['cart'] as $item) { ?>
          <tr class="rows">
            <td id="pic">
              <img src="img/store/<?php echo $item['name']; ?>.jpg" alt="Product Image" width="80px" class="flex-shrink-0 img-fluid rounded">
            </td>
            <td id="item">
            <?php echo $item['name']; ?>
            </td>
