...
<?php include("sideBar.php"); ?>
    <div class="main position-absolute vh-100 bg-white">
		...
		<div class="table me-5">
					<div class="mb-0 me-3">
						<h4 class="bg-light-brown text-white ms-2">&nbsp; Pending Orders </h4>
					</div>
		...
		$(document).ready(function() {
			...
			$(document).on('click', '.setDone', function() {
				...
				$.ajax({
					...
					success: function() {
						alert("Selected Order Done!!");
						let pendingCount = document.getElementById("pendingOrdersCount");
						let count = parseInt(pendingCount.innerHTML);
						pendingCount.innerHTML = count  - 1;
						LoadPendingOrders();
					}
				});
			});
