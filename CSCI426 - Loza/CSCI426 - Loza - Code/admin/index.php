            ...
            <div class="row g-3 my-2">
                ...
                <div class="col-md-3">
                    <div class="p-3 bg-light-brown shadow-sm d-flex justify-content-around align-items-center rounded">
                        ...
                        <i class="fa-solid fa-user-group fs-1 primary-text border rounded-pill bg-white p-3"></i>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="p-3 bg-light-brown shadow-sm d-flex justify-content-around align-items-center rounded">
                        ...
                        <i class="fa-solid fa-money-bills fs-1 primary-text border rounded-pill bg-white p-3"></i>
                    </div>
                </div>
            </div>
        </div>
