	...
	<div class="main position-absolute vh-100 bg-white">
				...
				<div class="col-md-4">
					<div class="p-3 bg-light-brown shadow-sm d-flex justify-content-around align-items-center rounded">
						<div>
							...
							<p class="fs-5">Denied Orders</p>
						</div>
						<i class="fa-regular fa-circle-xmark fs-1 primary-text border rounded-pill bg-white p-3"></i>
					</div>
				</div>
			</div>
		</div>
		<div class="table me-5">
			<div class="mb-0 me-3 ms-3">
				<h4 class="bg-light-brown text-white"> &nbsp; Denied Orders</h4>
			</div>
