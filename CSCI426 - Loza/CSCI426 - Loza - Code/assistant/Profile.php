					...
					<div class="p-3 bg-light-brown shadow-sm d-flex justify-content-around align-items-center rounded">
						<div>
							...
							<h3 class="fs-6">
								...
								$stmt->bind_param("s",$_SESSION['assistantLoginCredentials']['Username']);
								$stmt->execute();
			...
			<div class="border border-3 border-light-brown py-3 px-3">
				...
				<form action="updateProfile_backend/updateProfile_server.php" method="post" enctype="multipart/form-data">
					<div class="mb-3 mt-3">
						...
						<input type="text" class="form-control" id="username" placeholder="Enter username" value="<?php echo $_SESSION['assistantLoginCredentials']['Username'] ?>" name="username">
					...
					<div class="mb-3">
						...
						<input type="email" class="form-control" id="email" placeholder="Enter email" value="<?php echo $_SESSION['assistantLoginCredentials']['Email'] ?>" name="email">
						<?php printTakenEmail(); ?>	
					</div>
					<div class="mb-3">
