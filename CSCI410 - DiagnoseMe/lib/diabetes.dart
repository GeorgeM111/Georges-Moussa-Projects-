...
class Diabetes extends StatefulWidget {
  ...
  const Diabetes({Key? key, required this.username}) : super(key: key);
...
class _DiabetesState extends State<Diabetes> {
  ...
  Future<void> fetchSymptoms() async {
    try {
      ...
      final url = Uri.http(baseURL, 'getSymptoms.php', {'sid': '1'});
          ...
          title: Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  String result = calculateResult(count);
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => cholesterol(
                        username: widget.username,
                        diabetesResult: result,
                      ),
                    ),
                  );
                },
